...
def main():
    ...
    # Get voice ID from environment or use placeholder
    voice_id = os.getenv('ELEVENLABS_VOICE_ID', 'your_voice_id_here')
    if voice_id == 'your_voice_id_here':
        print("⚠️  Warning: Using placeholder voice ID")
        print("Set ELEVENLABS_VOICE_ID in .env to use your preferred voice")
