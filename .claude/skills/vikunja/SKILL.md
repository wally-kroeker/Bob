---
name: vikunja
description: Technical reference for TaskMan/Vikunja infrastructure. Provides MCP tool documentation, database query methods, and troubleshooting guides. This skill does NOT activate on user queries - use the 'taskman' skill instead for all user-facing task management requests.
---
...
**Configuration:**
- **Package**: `@democratize-technology/vikunja-mcp`
- **Command**: `npx -y @democratize-technology/vikunja-mcp`
- **Instance**: https://taskman.vrexplorers.com/api/v1
- **Authentication**: API Token (tk_*)
- **Config**: `~/.claude.json`
...
- API token stored in MCP configuration (`~/.claude.json`)
- Database password stored in query script (secured by file permissions)
- Never commit credentials to repositories
- API token has full permissions for task/project management
